 ...
 * @author User
 */
public class GastosMenuTurbo extends javax.swing.JFrame {

    /**
     * Creates new form Inicio
     */
    public GastosMenuTurbo() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButtonIngreso.setText("REGISTRAR GASTOS");
        ...
        getContentPane().add(jButtonIngreso, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 220, 300, 250));
...
public void transpareciaBoton(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GastosMenuTurbo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GastosMenuTurbo().setVisible(true);
            }
        });
    }
