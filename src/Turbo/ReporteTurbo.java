 ...
 * @author User
 */
public class ReporteTurbo extends javax.swing.JFrame {
    ...
    public ReporteTurbo() {
        ...
        try {
                ...
                Logger.getLogger(ReporteTurbo.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    void sumarDatosNeto(){
        ...
        for(int i=0; i<filas; i++){
            contNeto += Float.parseFloat((String) TablaDatos.getValueAt(i, 2));
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReporteTurbo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new ReporteTurbo().setVisible(true);
        });
    }
